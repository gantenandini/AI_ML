...
def get_conversational_chain():
    ...
    #if temperature is near to 1 then we asking the model to be more creative..but if it is near to 0 then we askng give the required answer only
    model = ChatGoogleGenerativeAI(model="gemini-pro", temperature=0.3) #temperature controls the randomness of the llm temperature values lies between 0 and 1
